...
export function MealCard({ meal }: { meal: Meal }) {
  ...
  return (
    <article className="card meal-card reveal group relative flex flex-col">
      <Link
        href={`/meals/${meal.id}`}
      ...
      <div className="px-4 pb-4">
        <button
          ...
          className="w-full btn-secondary hover:border-primary-300 hover:text-primary-700 flex items-center justify-center gap-2 text-sm py-2"
        >
