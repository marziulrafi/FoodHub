...
export default function AdminProvidersPage() {
  ...
  const handleReject = async (id: string) => {
    if (
      !(await confirmAction(
        "Reject provider?",
        "This restaurant application will be marked as rejected.",
        "Reject application",
      ))
    )
      return;
    try {
      ...
      toast.error(
        err instanceof Error ? err.message : "Failed to reject provider.",
      );
    }
  };
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <p className="text-gray-500 mb-6">
        Review and approve pending restaurants.
      </p>
              ...
              <div className="flex items-start justify-between gap-4 flex-wrap">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    disabled={
                      approveProvider.isPending || rejectProvider.isPending
                    }
